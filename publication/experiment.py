...
from hana.recording import load_traces, load_timeseries, partial_timeseries, electrode_neighborhoods
    ...
    def comparison_of_discriminators(self, compared_neurons):
        ...
        if os.path.isfile(evaluation_filename):
            ...
            for neuron in compared_neurons:
                V, t, x, y, trigger, neuron = Experiment(self.culture).traces(neuron)
