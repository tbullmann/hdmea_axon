...
if __name__ == "__main__":
    ...
    figure_comparison.make_figure('Figure 3', figpath=figpath)
    figure_dendrite.make_figure('Figure 4', figpath=figpath)
    figure_structural_and_functional.make_figure('Figure 5', figpath=figpath)
    figure_structur_vs_function_and_synapses.make_figure('Figure 6', figpath=figpath)
